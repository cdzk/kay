...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{$Think.PATH_ADMIN_STATIC}dist/css/AdminLTE.min.css">
...
<!-- jQuery 2.2.3 -->
<script src="{$Think.PATH_ADMIN_STATIC}plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.7 -->
